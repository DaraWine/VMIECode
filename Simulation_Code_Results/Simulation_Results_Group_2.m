...
S = imread("Digital_signature\CTBU.tiff");
M = imread("Original_Images\Peppers.tiff");
C = imread("Original_Images\Male.tiff");
...
imwrite(M_1,"Group_2\Result_2\M_1.tiff");
imwrite(M_2,"Group_2\Result_2\M_2.tiff");
imwrite(C_1,"Group_2\Result_2\C_1.tiff");
imwrite(C_2,"Group_2\Result_2\C_2.tiff");
imwrite(C_3,"Group_2\Result_2\C_3.tiff");

imwrite(M_extract_2,"Group_2\Result_2\M_extract_2.tiff");
imwrite(M_extract_1,"Group_2\Result_2\M_extract_1.tiff");
imwrite(Signature_extract_2,"Group_2\Result_2\Signature_extract_2.tiff");
imwrite(Signature_extract_1,"Group_2\Result_2\Signature_extract_1.tiff");

%% psnr : 58.1373; Decryption time:0.2332s; Encryption time 0.4196s
...
%% Quality meansure 
% C and C_3: nc:0.9991
% C and C_3 IE: 7.5237 7.5230
% C and C_3  psnr: 44.5178 dB
% M an M_extract psnr: 57.1373 dB
...
NC(Signature_extract_1_sp,S)
psnr(M_extract_1_sp,M)
imwrite(M_extract_1_sp,"Group_2\Robustness\S&P\S&P_M_3.tiff");
